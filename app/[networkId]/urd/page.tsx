...
import { customEncodeAddresses, generateMappingKey, generateMappingKeyFromAddress, toggleUniveralAssistantsSubscribe, updateBECPermissions } from '@/utils/configDataKeyValueStore';
...
const UAPConfigPage: React.FC<UAPConfigPageProps> = ({ params }) => {
  ...
  const turnOnAssistant = async (event: React.FormEvent<HTMLFormElement>) => {
